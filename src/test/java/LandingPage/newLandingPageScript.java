...
public class newLandingPageScript extends baseclass {
    @Test
    public void landingpageverification() throws InterruptedException, IOException {
        String domain = url;
...
//                }
                ...
                WebElement ui_loc = driver.findElement(By.xpath("//*[contains(text(),'Location :') or contains(@src,'location')]//parent::p | //h1/following-sibling::p[1]"));
